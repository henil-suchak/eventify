...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    profile_picture = models.ImageField(upload_to="profile_pics/", blank=True, null=True, default="profile_pics/default_profile.png")  # ✅ Default Image Added
    ...
    REQUIRED_FIELDS = ["name"]  # ✅ Removed "username" since it's not in your model
